...
This is a fully CRUD capable application, to demonstrate understanding of how using the Python Flask Framework & WSGI hosted on custom configured Ubuntu instance in the cloud on AWS on a custom configured instance of a server (Ubuntu 18.04) on AWS lightsail.
